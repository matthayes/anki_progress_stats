...
def _get_reviews(
  bucket_size_days, day_cutoff_seconds,
  ...
  num_buckets is the (optional) number of buckets, which indicates how many reviews to fetch.  Enough reviews are fetched to
  fill all the buckets.  So, for example, if bucket_size_days is 1 and num_buckets is 30 this fetches the last month
  of reviews.
